...
# from yao.lib.pnl import OperationManager
from user.lib.pycommon.data import format_date
...
class Sim:
    ...
    def register_expr(self):
        from yao.B.basic.expr.expr import expr_macro
    ...
    def register_store(self):
        from yao.lib.pycommon.store import Store
